...
/* SQL text to insert 16 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'c51e4c9e-a081-47e8-aad6-0beb98c1ee05' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'ID')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 1,
            'ID',
            'ID',
            NULL,
            'uniqueidentifier',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'ed6c3d61-fbd9-40ce-95f3-535772bc0969' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'FormID')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 2,
            'FormID',
            'Form ID',
            NULL,
            'uniqueidentifier',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'dd5623e5-abf9-479f-980f-a878f58f878a' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'ScreenType')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 3,
            'ScreenType',
            'Screen Type',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '0d777b61-d720-4d6a-81db-8833a7c7bff4' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'Title')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 4,
            'Title',
            'Title',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'ae0569d6-7b7d-4866-8a43-7a32742083d0' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'Body')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 5,
            'Body',
            'Body',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '33293d30-0c67-477f-b21e-a737ff3860b0' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'ButtonLabel')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 6,
            'ButtonLabel',
            'Button Label',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '1c327b5b-24da-42e4-ad5e-82c27eae804d' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'MediaURL')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 7,
            'MediaURL',
            'Media URL',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '672bf4fe-4673-4912-902b-b8a1e41a9806' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'RedirectURL')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 8,
            'RedirectURL',
            'Redirect URL',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '56d1a7d1-394e-477a-9e03-79be9dba1598' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'DisplayOrder')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 9,
            'DisplayOrder',
            'Display Order',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'a415fc2e-31ee-4817-98ae-457d21527cef' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'ConditionalRule')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 10,
            'ConditionalRule',
            'Conditional Rule',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '2448e280-b435-4b75-9c68-4db2af63d664' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'IsDefault')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 11,
            'IsDefault',
            'Is Default',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '47a0fbd1-6905-474f-a7bc-fab6c4a4378d' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = '__mj_CreatedAt')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 12,
            '__mj_CreatedAt',
            'Created At',
            NULL,
            'datetimeoffset',
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'd20e07ae-275a-4fe2-9aa4-a761dc65d543' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = '__mj_UpdatedAt')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 13,
            '__mj_UpdatedAt',
            'Updated At',
            NULL,
            'datetimeoffset',
...
/* Create Entity Relationship: MJ_BizApps_Forms: Forms -> MJ_BizApps_Forms: Form Screens (One To Many via FormID) */
   ...
   BEGIN
      INSERT INTO [${mjSchema}].[EntityRelationship] ([ID], [EntityID], [RelatedEntityID], [RelatedEntityJoinField], [Type], [BundleInAPI], [DisplayInForm], [Sequence], [__mj_CreatedAt], [__mj_UpdatedAt])
                    VALUES ('6729890a-d62c-4806-8fd3-3ce466fd0395', 'C6DB9AD8-11EA-451B-B0E1-71D7BFD894B8', '6313B0B1-37E8-432F-AEB6-F35F218C5D22', 'FormID', 'One To Many', 1, 1, 9, GETUTCDATE(), GETUTCDATE())
   END;
...
EXEC [${mjSchema}].[spDeleteUnneededEntityFields] @ExcludedSchemaNames='sys,staging,dbo,${mjSchema},${mjSchema}_BizAppsCommon,${mjSchema}_BizAppsTasks,${mjSchema}_bizappscommon,${mjSchema}_bizappstasks', @EntityIDs='6313B0B1-37E8-432F-AEB6-F35F218C5D22,BF3016E2-8BA7-4975-83B6-02C9435C1441,A3BFAA2D-3158-4EED-9934-76D1E35D20F6';

/* SQL text to insert 1 new entity field(s) */

      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '3cc65fc2-7770-407a-96f0-12e9482cb6ad' OR (EntityID = '6313B0B1-37E8-432F-AEB6-F35F218C5D22' AND Name = 'Form')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
         ...
         (
            ...
            '6313B0B1-37E8-432F-AEB6-F35F218C5D22', -- Entity: MJ_BizApps_Forms: Form Screens
            (SELECT COALESCE(MAX([Sequence]), 0) FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '6313B0B1-37E8-432F-AEB6-F35F218C5D22') + 14,
            'Form',
            'Form',
            NULL,
            'nvarchar',
...
EXEC [${mjSchema}].[spUpdateExistingEntityFieldsFromSchema] @ExcludedSchemaNames='sys,staging,dbo,${mjSchema},${mjSchema}_BizAppsCommon,${mjSchema}_BizAppsTasks,${mjSchema}_bizappscommon,${mjSchema}_bizappstasks', @EntityIDs='6313B0B1-37E8-432F-AEB6-F35F218C5D22,BF3016E2-8BA7-4975-83B6-02C9435C1441,A3BFAA2D-3158-4EED-9934-76D1E35D20F6';
