...
export const WIDGET_ICON_GLYPHS = {
  ...
  // Font Awesome 6 Free "circle-info" (solid), the same source as every glyph beside it, inlined
  // for the same reason: the respondent host page loads no stylesheet at all, so a `fa-*` class
  // draws nothing (#115).
  'circle-info': {
    viewBox: '0 0 512 512',
